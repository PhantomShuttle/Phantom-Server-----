...
#define OLED_SPI_SDIN  BIT6
#define OLED_SPI_SCLK BIT7
#define OLED_SPI_DC  BIT4
#define OLED_SPI_RST BIT5

#define OLED_SPI_SDIN_H 	SETBIT(PORTD, OLED_SPI_SDIN )	//SPI通信数据线
#define OLED_SPI_SDIN_L 	CLEARBIT(PORTD, OLED_SPI_SDIN)	//SPI通信数据线
#define OLED_SPI_SCLK_H     SETBIT(PORTD, OLED_SPI_SCLK )          //SPI通信时钟线
#define OLED_SPI_SCLK_L     CLEARBIT(PORTD, OLED_SPI_SCLK)          //SPI通信时钟线
#define OLED_SPI_DC_H       SETBIT(PORTD, OLED_SPI_DC )        
#define OLED_SPI_DC_L       CLEARBIT(PORTD, OLED_SPI_DC)
#define  OLED_SPI_RST_H     SETBIT(PORTD, OLED_SPI_RST )
#define  OLED_SPI_RST_L     CLEARBIT(PORTD, OLED_SPI_RST)
